...
@section('page-title','All Programs')
...
<div class="page-header">
    <div>
        <h2><i class="text-primary"></i>All Programs</h2>
            ...
            <div class="card program-card {{ $program->status }}">
                ...
                <div class="card-body p-3">
                    ...
                    <div class="d-flex flex-wrap gap-2">
                        ...
                        {{-- Committee --}}
                        {{-- <a href="{{ route('admin.committee.index', $program->id) }}"
                        class="action-btn"
                ...
                <div class="modal-body">
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            ...
                            <select name="created_by" id="edit_user" class="form-select" required>
                        ...
                        <div class="col-12">
                            ...
                            <input type="text" id="edit_department_display" class="form-control" value="" disabled>
                        </div>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    document.getElementById('editModal').addEventListener('show.bs.modal', e => {
        ...
        form.action = `/admin/programs/${btn.dataset.id}`;
    ...
    //    document.getElementById('edit_department').value  = btn.dataset.department;
        ...
        // NEW: set selected user, then sync department display
        const userSelect = document.getElementById('edit_user');
        userSelect.value = btn.dataset.user;
        syncEditDepartmentDisplay();
    ...
    function syncEditDepartmentDisplay() {
    const select = document.getElementById('edit_user');
    const selected = select.options[select.selectedIndex];
    document.getElementById('edit_department_display').value =
        selected ? (selected.dataset.departmentName || '') : '';
    }

    document.getElementById('edit_user').addEventListener('change', syncEditDepartmentDisplay);


    document.getElementById('rescheduleModal').addEventListener('show.bs.modal', e => {
        const btn = e.relatedTarget;
        document.getElementById('rescheduleForm').action           = `/admin/programs/${btn.dataset.id}/reschedule`;
    ...
    document.getElementById('cancelModal').addEventListener('show.bs.modal', e => {
        const btn = e.relatedTarget;
        document.getElementById('cancelForm').action            = `/admin/programs/${btn.dataset.id}/cancel`;
    ...
    document.getElementById('deleteModal').addEventListener('show.bs.modal', e => {
        const btn = e.relatedTarget;
        document.getElementById('deleteForm').action            = `/admin/programs/${btn.dataset.id}`;
