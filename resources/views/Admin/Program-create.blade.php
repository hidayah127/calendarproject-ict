    ...
    <div>
        ...
        <nav aria-label="breadcrumb" class="mt-1">
            <ol class="breadcrumb mb-0">
                ...
                <li class="breadcrumb-item"><a href="{{ route('admin.programs.index') }}">My Programs</a></li>
                <li class="breadcrumb-item active">Create</li>
            </ol>
        </nav>
    </div>

    <a href="{{ route('admin.programs.index') }}" class="btn-back">
                ...
                <form method="POST" action="{{ route('admin.programs.store') }}">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="description"
                                  ...
                                  rows="6">{{ old('description', "\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\nCreated by: " . auth()->user()->name . " (" . strtoupper(auth()->user()->role) . ")\nCreated on: " . now()->format('d M Y H:i')) }}</textarea>
                        @error('description')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                         <div style="font-size:12.5px;color:#94a3b8;margin-top:6px;">
                            <i class="fa fa-circle-info me-1"></i>
                            Briefly describe the program objectives, audience, or agenda.
                        </div>
                    </div>  
