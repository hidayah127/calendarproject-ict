    ...
    <div class="toolbar">
        ...
        <form method="GET" action="{{ route('vc.programs') }}">
            ...
            <div class="toolbar-right">
                ...
                @else
                    <button type="button" onclick="printWeekly()" class="print-btn">
                        <i class="fa fa-print"></i> Weekly
                    </button>
                @endif
...
<div id="weeklyPrint" style="display:none; padding:40px; font-family:Arial;">
    ...
    @foreach($weeklyPrograms as $week => $items)
        ...
        <table width="100%" cellspacing="0" cellpadding="10" style="border-collapse:collapse; margin-top:10px;">
    ...
    win.document.write(`
        ...
        <head>
            ...
            <style>
                ...
                th { background:#0f2d6e; color:white; }
...
function printWeekly() {
    openPrint(document.getElementById('weeklyPrint').innerHTML);
}
